                ...
                <div class="row no-gutters align-items-center">
                    <div class="col-lg-3 col-md-6">
                        <div class="d-single-info">
                            ...
                            <p>(not {{ $user->name }}? <a href="{{ route('logout-get') }}">Log Out</a>)</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="d-single-info">
            ...
            <div class="row">
                <div class="col-lg-2">
                    ...
                    <ul class="nav flex-column dashboard-list" role="tablist">
                        ...
                        <li><a href="{{ route('logout-get') }}" href="#logout">logout</a></li>
                    </ul>
                </div>
                <div class="col-lg-10">
                    <!-- Tab panes -->
                            ...
                            <div class="register-form login-form clearfix">
                                <form action="#">
                                    ...
                                    <div class="form-group row">
                                        <label for="name" class="col-lg-3 col-md-4 col-form-label">First Name</label>
                                        <div class="col-lg-6 col-md-8">
                                            <input type="text" class="form-control" id="name" value="{{ $user->name }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="last_name" class="col-lg-3 col-md-4 col-form-label">Last Name</label>
                                        <div class="col-lg-6 col-md-8">
