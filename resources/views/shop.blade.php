                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-content">
                                                    ...
                                                    <h4><a href="{{ route('product',$product->code) }}">{{ $product->name }}</a></h4>
                                                    ...
                                                    <div class="pro-actions">
                                                        <div class="actions-secondary">
                                                            ...
                                                            <a class="add-cart" href="{{ route('add-to-cart', $product->id) }}" data-toggle="tooltip" title="Add to Cart">Add To Cart</a>
